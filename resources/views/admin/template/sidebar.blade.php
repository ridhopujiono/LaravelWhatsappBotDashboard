    ...
    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
        ...
        <li class="nav-item">
            ...
            <a class="nav-link {{(stripos($title, 'Daftar Peminat') !== false) ? 'active': ''}}" href="{{url('interest')}}">
                ...
                <span class="nav-link-text">Daftar Peminat</span>
            </a><!--//nav-link-->
        </li><!--//nav-item-->
        <li class="nav-item">
            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
            <a class="nav-link {{(stripos($title, 'Usulan Proyek') !== false) ? 'active': ''}}" href="{{url('request_project')}}">
                <span class="nav-icon">
        ...
        <li class="nav-item">
            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
            <a class="nav-link {{(stripos($title, 'Lantai Rumah') !== false) ? 'active': ''}}" href="{{url('house_floor')}}">
                <span class="nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bar-chart-steps" viewBox="0 0 16 16">
                        <path d="M.5 0a.5.5 0 0 1 .5.5v15a.5.5 0 0 1-1 0V.5A.5.5 0 0 1 .5 0zM2 1.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-4a.5.5 0 0 1-.5-.5v-1zm2 4a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5v-1zm2 4a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-6a.5.5 0 0 1-.5-.5v-1zm2 4a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-7a.5.5 0 0 1-.5-.5v-1z" />
                    </svg>
                </span>
                <span class="nav-link-text">Lantai Rumah</span>
            </a><!--//nav-link-->
        </li><!--//nav-item-->
        <li class="nav-item">
            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
            <a class="nav-link {{(stripos($title, 'Tipe Rumah') !== false) ? 'active': ''}}" href="{{url('house_type')}}">
                <span class="nav-icon">
                ...
                <span class="nav-link-text">Tipe Rumah</span>
            </a><!--//nav-link-->
        </li><!--//nav-item-->
        <li class="nav-item">
            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
            <a class="nav-link {{(stripos($title, 'Data Master') !== false) ? 'active': ''}}" href="{{url('master')}}">
                <span class="nav-icon">
        ...
        <li class="nav-item fw-bold px-2 py-2 text-success" style="font-size: 15px;">Kustom Menu</li>
        <li class="nav-item">
            <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
            <a class="nav-link {{(stripos($title, 'Kustom Menu') !== false) ? 'active': ''}}" href="{{url('custom_menu')}}">
                <span class="nav-icon">
                ...
                <span class="nav-link-text">Kustom Menu</span>
            </a><!--//nav-link-->
        </li><!--//nav-item-->
    </ul><!--//app-menu-->
</nav><!--//app-nav-->