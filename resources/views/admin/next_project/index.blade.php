                    ...
                    <table class="table table-striped" id="datatableId">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="badge bg-{{ ($d->type == 'ruko') ? 'danger' : (($d->type == 'tanah') ? 'warning' : (($d->type == 'minat_lain') ? 'info' : (($d->type == 'lokasi_request') ? 'primary' : (($d->type == 'lokasi_fix') ? 'success' : 'secondary')))) }}">
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        ...
                                        <a href="{{url('request_project/'.$d->id)}}" class="badge bg-warning" style="border: unset">detail</a>
                                        <form action="{{ url('request_project/'.$d->id) }}" method="POST" id="delete-form">
                                            @csrf
                                            @method('DELETE')
